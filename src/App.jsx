...
import Header from './component/plants_shopping/Header'; // Make sure the path to your Header is correct
import PlantLanding from './component/plants_shopping/Landing'; // Make sure paths are correct
import ProductList from '../src/component/plants_shopping/ProductList';
import AboutUs from '../src/component/plants_shopping/AboutUs';
import CartItem from './component/plants_shopping/CartItem';
import Checkout from './component/plants_shopping/Checkout';

// 1. We wrap the layout with a MainLayout component so useNavigate works correctly inside it
const MainContent = () => {
  ...
  return (
    <>
      ...
      <main>
        <Routes>
          {/* This renders your Landing Page styling ONLY on the /landing route */}
          <Route 
            path="/plant-shopping/landing" 
            element={
              <div className="bg-plant-bg bg-cover bg-center h-screen w-full flex items-center">
                <div className="grid lg:grid-cols-3 gap-4 max-w-6xl mx-auto px-6 w-full items-center">
                  ...
                  <div className="flex flex-col lg:col-span-2">
                    <p className="text-white items-center text-center font-semibold">Welcome to Paradise Nursery, where green meets serenity!</p>
...
// 2. The main exported component that wraps everything inside the Router provider
const App = () => {
  return (
    <Router>
      <MainContent />
